...
export default function AddArticlePage() {
  ...
  const [author, setAuthor] = useState(session?.user?.name || "Tim Redaksi KIM")
    ...
    <div className="space-y-6 max-w-4xl mx-auto animate-fade-in-up">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Buat publikasi baru untuk portal berita KIM.</p>
        </div>
      </div>
            ...
            <div className="bg-white border border-gray-200/80 rounded-2xl p-6 space-y-4 shadow-sm">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  required
                  rows={3}
                  placeholder="Tulis ringkasan singkat artikel (tampil di halaman daftar)"
                  value={excerpt}
